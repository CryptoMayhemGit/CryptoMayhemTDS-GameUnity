...
Shader "terrainTexture_01"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		_terrain_Scale_pebble_024k("terrain_Scale_pebble_02 4k", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			#endif
			CBUFFER_END
			sampler2D _terrain_Scale_pebble_024k;
						...
						)
			{
				...
				surfaceDescription.Albedo = tex2D( _terrain_Scale_pebble_024k, (appendResult22*_scale + _offset) ).rgb;
...
/*ASEBEGIN
Version=18934
0;631;1698;768;1709.5;289.5;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;24;-826.5,180.5;Inherit;False;Property;_scale;scale;1;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ScaleAndOffsetNode;23;-800,0;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT;1;False;2;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.WorldPosInputsNode;21;-1280,0;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector2Node;25;-982.5,227.5;Inherit;False;Property;_offset;offset;2;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SamplerNode;20;-544,0;Inherit;True;Property;_terrain_Scale_pebble_024k;terrain_Scale_pebble_02 4k;0;0;Create;True;0;0;0;False;0;False;-1;0b7c77c2b1015984688f282c7a1dd56a;0b7c77c2b1015984688f282c7a1dd56a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;22;-1008,0;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=B2E38C0A534105E3E03C976C4CD82733EB0E0AE5