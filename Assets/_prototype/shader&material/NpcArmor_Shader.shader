...
Shader "NpcArmor_Shader"
{
	Properties
	{
		...
		_armor_type1("armor_type1", Color) = (0.5294118,0.8509805,0,1)
		_armor_type2("armor_type2", Color) = (0.9058824,0.7921569,0,1)
		_armor_type3("armor_type3", Color) = (0.8588236,0.3215686,0,1)
		_armor_type4("armor_type4", Color) = (0.01176468,0.6365865,0.8313726,1)
		_armor_miscellaneous("armor_miscellaneous", Color) = (1,0,1,0)
		[ASEEnd][IntRange][Enum(none,0,type1,1,type2,2,type3,3,type4,4,miscellaneous,5)]_npc_armorType("npc_armorType", Range( 0 , 4)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _armor_type3;
			float4 _armor_type4;
			float4 _armor_miscellaneous;
			float _npc_armorType;
			float _metalic;
			...
			struct PackedVaryingsMeshToPS
			{
				...
				FRONT_FACE_TYPE cullFace : FRONT_FACE_SEMANTIC;
					...
					float2 voronoihash342( float2 p )
					{
					...
					float voronoi342( float2 v, float time, inout float2 id, inout float2 mr, float smoothness, inout float2 smoothId )
					{
						float2 n = floor( v );
						float2 f = frac( v );
						float F1 = 8.0;
						...
						)
			{
				...
				int temp_output_8_0_g9 = (int)_npc_armorType;
				float4 temp_output_9_0_g9 = float4( 0,0,0,0 );
				float4 temp_output_10_0_g9 = _armor_type1;
				float4 temp_output_11_0_g9 = _armor_type2;
				float4 temp_output_12_0_g9 = _armor_type3;
				float4 temp_output_13_0_g9 = _armor_type4;
				float4 temp_output_14_0_g9 = _armor_miscellaneous;
				...
				float4 npc_armorType66 = lerpResult29_g9;
				float time342 = 0.0;
				float2 voronoiSmoothId342 = 0;
				float2 coords342 = packedInput.ase_texcoord5.xy * 6.0;
				float2 id342 = 0;
				float2 uv342 = 0;
				float voroi342 = voronoi342( coords342, time342, id342, uv342, 0, voronoiSmoothId342 );
				float4 COLOR21 = ( npc_armorType66 * voroi342 );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float time342 = 0.0;
				float2 voronoiSmoothId342 = 0;
				float2 coords342 = packedInput.ase_texcoord2.xy * 6.0;
				float2 id342 = 0;
				float2 uv342 = 0;
				float voroi342 = voronoi342( coords342, time342, id342, uv342, 0, voronoiSmoothId342 );
				float4 COLOR21 = ( npc_armorType66 * voroi342 );
		...
		Pass
		{
						...
						)
			{
				...
				float time342 = 0.0;
				float2 voronoiSmoothId342 = 0;
				float2 coords342 = packedInput.ase_texcoord7.xy * 6.0;
				float2 id342 = 0;
				float2 uv342 = 0;
				float voroi342 = voronoi342( coords342, time342, id342, uv342, 0, voronoiSmoothId342 );
				float4 COLOR21 = ( npc_armorType66 * voroi342 );
...
/*ASEBEGIN
Version=18934
429;1469;1826;1014;6114.829;2036.458;1.593606;True;False
...
Node;AmplifyShaderEditor.ColorNode;62;-4352,-2176;Inherit;False;Property;_armor_type1;armor_type1;3;0;Create;True;0;0;0;False;0;False;0.5294118,0.8509805,0,1;0.9716981,0.6372315,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VoronoiNode;342;-2251.576,-2050.217;Inherit;True;0;0;1;4;1;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;10;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
...
Node;AmplifyShaderEditor.RangedFloatNode;344;-2393.828,-1982.542;Inherit;False;Constant;_noise_scale;noise_scale;9;0;Create;True;0;0;0;False;0;False;6;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;63;-4352,-1917;Inherit;False;Property;_armor_type2;armor_type2;4;0;Create;True;0;0;0;False;0;False;0.9058824,0.7921569,0,1;0,1,0.8571169,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;22;1280,-2176;Inherit;False;21;COLOR;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.ColorNode;161;-4352,-1408;Inherit;False;Property;_armor_type4;armor_type4;6;0;Create;True;0;0;0;False;0;False;0.01176468,0.6365865,0.8313726,1;0,1,0.4171928,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;64;-4352,-1664;Inherit;False;Property;_armor_type3;armor_type3;5;0;Create;True;0;0;0;False;0;False;0.8588236,0.3215686,0,1;0,1,0.4171928,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;343;-2046.828,-2054.542;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;21;-2146.921,-2146.329;Inherit;False;COLOR;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;78;-2688,-2176;Inherit;False;66;npc_armorType;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;66;-3120,-2176;Inherit;False;npc_armorType;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;74;-3840,-1856;Inherit;False;Property;_npc_armorType;npc_armorType;8;2;[IntRange];[Enum];Create;True;0;6;none;0;type1;1;type2;2;type3;3;type4;4;miscellaneous;5;0;False;0;False;1;1;0;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;77;-4352,-1152;Inherit;False;Property;_armor_miscellaneous;armor_miscellaneous;7;0;Create;True;0;0;0;False;0;False;1,0,1,0;1,0,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;343;0;78;0
WireConnection;343;1;342;0
WireConnection;21;0;343;0
...
ASEEND*/
//CHKSM=BEC1F5A6BF2BB914BC41DA3F039C579D3474BED4