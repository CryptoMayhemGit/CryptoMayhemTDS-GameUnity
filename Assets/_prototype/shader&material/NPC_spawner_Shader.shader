...
Shader "NPC_spawner_Shader"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		_color("color", Color) = (0.5019608,0.2509804,0.4580717,0)
		_smoothness("smoothness", Range( 0 , 1)) = 0
		_metalic("metalic", Range( 0 , 1)) = 0
		_emission("emission", Float) = 1
		_noise_scale("noise_scale", Float) = 10
		_fresnel_scale("fresnel_scale", Float) = 2.5
		[ASEEnd]_fresnel_power("fresnel_power", Float) = 2
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 hsvTorgb22 = RGBToHSV( _color.rgb );
				float3 hsvTorgb24 = HSVToRGB( float3(( hsvTorgb22.x + 0.1 ),hsvTorgb22.y,( hsvTorgb22.z * 0.1 )) );
				float time17 = 0.0;
				float2 voronoiSmoothId17 = 0;
				float2 texCoord20 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner19 = ( 1.0 * _Time.y * float2( 0,0.25 ) + texCoord20);
				float2 coords17 = panner19 * _noise_scale;
				float2 id17 = 0;
				float2 uv17 = 0;
				float voroi17 = voronoi17( coords17, time17, id17, uv17, 0, voronoiSmoothId17 );
				float4 lerpResult25 = lerp( float4( hsvTorgb24 , 0.0 ) , _color , voroi17);
				float fresnelNdotV31 = dot( normalWS, V );
				float fresnelNode31 = ( 0.0 + _fresnel_scale * pow( 1.0 - fresnelNdotV31, _fresnel_power ) );
				float4 lerpResult34 = lerp( lerpResult25 , _color , saturate( fresnelNode31 ));
				
				float3 hdEmission15 = ASEGetEmissionHDRColor(lerpResult34.rgb,_emission,0.0,GetInverseCurrentExposureMultiplier());
				
				surfaceDescription.Albedo = lerpResult34.rgb;
				...
				surfaceDescription.Emission = hdEmission15;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float time17 = 0.0;
				float2 voronoiSmoothId17 = 0;
				float2 texCoord20 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner19 = ( 1.0 * _Time.y * float2( 0,0.25 ) + texCoord20);
				float2 coords17 = panner19 * _noise_scale;
				float2 id17 = 0;
				float2 uv17 = 0;
		...
		Pass
		{
						...
						)
			{
				...
				float time17 = 0.0;
				float2 voronoiSmoothId17 = 0;
				float2 texCoord20 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner19 = ( 1.0 * _Time.y * float2( 0,0.25 ) + texCoord20);
				float2 coords17 = panner19 * _noise_scale;
				float2 id17 = 0;
				float2 uv17 = 0;
...
/*ASEBEGIN
Version=18934
417;1484;1838;1005;1556.511;589.0141;1;True;False
Node;AmplifyShaderEditor.FresnelNode;31;-896,-1152;Inherit;True;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-1152,128;Inherit;False;Property;_emission;emission;3;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;34;288,-1152;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-1152,256;Inherit;False;Property;_smoothness;smoothness;1;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;32;-1152,-1152;Inherit;False;Property;_fresnel_scale;fresnel_scale;5;0;Create;True;0;0;0;False;0;False;2.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;33;-1152,-1088;Inherit;False;Property;_fresnel_power;fresnel_power;6;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.HDEmissionNode;15;384,128;Inherit;False;Luminance;False;3;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;20;-1152,-384;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;19;-928,-384;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0.25;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-1152,-256;Inherit;False;Property;_noise_scale;noise_scale;4;0;Create;True;0;0;0;False;0;False;10;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;25;48,-896;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RGBToHSVNode;22;-896,-768;Inherit;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SaturateNode;35;-240,-1152;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;12;-1152,-896;Inherit;False;Property;_color;color;0;0;Create;True;0;0;0;False;0;False;0.5019608,0.2509804,0.4580717,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VoronoiNode;17;-272,-384;Inherit;True;0;0;1;0;1;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.HSVToRGBNode;24;-320,-768;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;14;-1152,192;Inherit;False;Property;_metalic;metalic;2;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;-624,-592;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;28;-896,-576;Inherit;False;Constant;_value;value;5;0;Create;True;0;0;0;False;0;False;0.1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-896,-640;Inherit;False;Constant;_hue;hue;6;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;26;-608,-720;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=5E8552F5D07CFB86C4C151213F9AAA55F8298B13