...
Shader "DLNK Shaders/ASE HDRP/Nature/LeavesAnim"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_ColorA("Color A", Color) = (0.5943396,0.5943396,0.5943396,0)
		...
		[ASEEnd]_NoiseScale("Noise Scale", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float temp_output_42_0 = ( texCoord18.x + -0.5 );
				float4 appendResult27 = (float4(( temp_output_42_0 * sin( _TimeParameters.x * 0.25 ) * _MotionValue.x ) , ( texCoord18.y * cos( _TimeParameters.x * 0.25 ) * _MotionValue.y ) , 0.0 , 0.0));
				float4 appendResult39 = (float4(temp_output_42_0 , texCoord18.y , 0.0 , 0.0));
				float2 temp_cast_0 = (_Noisespeed).xx;
				float2 panner56 = ( 1.0 * _Time.y * temp_cast_0 + texCoord18);
				...
				#endif
				float3 vertexValue = ( appendResult27 * appendResult39 * simplePerlin2D57 ).xyz;
						...
						)
			{
				...
				surfaceDescription.Albedo = ( tex2DNode7 * lerpResult49 ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 tex2DNode7 = tex2D( _MainTex, uv_MainTex );
				float2 texCoord18 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_42_0 = ( texCoord18.x + -0.5 );
				float4 appendResult39 = (float4(temp_output_42_0 , texCoord18.y , 0.0 , 0.0));
				float4 lerpResult49 = lerp( _ColorA , _ColorB , appendResult39);
...
/*ASEBEGIN
Version=18935
2032;-21;1920;1019;1388.716;343.7772;1.3;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;59;-282.3127,895.4478;Inherit;False;Property;_Noisespeed;Noise speed;7;0;Create;True;0;0;0;False;0;False;1;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CosTime;28;-601.1729,495.8477;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;40;-476.1775,654.2297;Inherit;False;Property;_MotionValue;Motion Value;6;0;Create;True;0;0;0;False;0;False;1,1;0.1,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SinTimeNode;24;-460.1729,490.8477;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;60;-265.9093,977.4645;Inherit;False;Property;_NoiseScale;Noise Scale;8;0;Create;True;0;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;51;-247.9164,-463.9396;Inherit;False;Property;_ColorB;Color B;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.6121395,0.7169812,0.6288617,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;50;-256.9837,-640.1237;Inherit;False;Property;_ColorA;Color A;0;0;Create;True;0;0;0;False;0;False;0.5943396,0.5943396,0.5943396,0;0.5283019,0.5283019,0.5283019,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-713.1729,223.8477;Inherit;False;Property;_NormalScale;NormalScale;5;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;7;-533,-255;Inherit;True;Property;_MainTex;Albedo;2;0;Create;False;0;0;0;False;0;False;-1;None;5147a6f1185266247aa2095de0c641b4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;55;-106.7086,118.1799;Inherit;False;Property;_Smoothness;Smoothness;4;0;Create;True;0;0;0;False;0;False;0;0.17;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;11;-486,49.5;Inherit;True;Property;_BumpMap;Normal;3;0;Create;False;0;0;0;False;0;False;-1;None;fdefceacd1bad114b9b73e471f72cc2b;True;0;True;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;78;7;55;0
WireConnection;78;9;7;4
WireConnection;78;11;32;0
ASEEND*/
//CHKSM=7203C357FC101D6C16E6F05B88ACE5AF8CB0A12F