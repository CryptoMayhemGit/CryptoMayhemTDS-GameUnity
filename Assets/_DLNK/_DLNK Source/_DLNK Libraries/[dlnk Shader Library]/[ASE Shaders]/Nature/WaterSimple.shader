...
Shader "DLNK Shaders/ASE HDRP/Nature/WaterSimple"
{
	Properties
	{
		...
		[ASEEnd]_FoamFalloff("FoamFalloff", Float) = -3
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float eyeDepth3 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float temp_output_5_0 = abs( ( eyeDepth3 - screenPos.w ) );
				float temp_output_10_0 = saturate( pow( ( temp_output_5_0 + _Depth ) , _Falloff ) );
				...
				float2 panner13 = ( 1.0 * _Time.y * temp_cast_5 + ( appendResult34 * _UVScaleB ).xy);
				...
				float4 fetchOpaqueVal43 = ASEHDSampleSceneColor(( float3( (ase_grabScreenPosNorm).xy ,  0.0 ) + ( temp_output_17_0 * _Distorsion ) ).xy, 0.0, GetInverseCurrentExposureMultiplier());
				float4 lerpResult44 = lerp( lerpResult64 , fetchOpaqueVal43 , temp_output_10_0);
				...
				surfaceDescription.Albedo = lerpResult44.rgb;
				surfaceDescription.Normal = temp_output_17_0;
				...
				surfaceDescription.Smoothness = lerpResult68;
				...
				#ifdef _DEPTHOFFSET_ON
				surfaceDescription.DepthOffset = lerpResult67;
				#endif
		...
		Pass
		{
					...
					)
			{
				...
				float2 temp_cast_0 = (_VelocityXYFoamZ.x).xx;
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float4 appendResult34 = (float4(ase_worldPos.x , ase_worldPos.z , 0.0 , 0.0));
				float4 temp_output_35_0 = ( appendResult34 * _UVScale );
				float2 panner12 = ( 1.0 * _Time.y * temp_cast_0 + temp_output_35_0.xy);
				float3 unpack21 = UnpackNormalScale( tex2D( _NormalA, panner12 ), _NormalScale );
				unpack21.z = lerp( 1, unpack21.z, saturate(_NormalScale) );
				float2 temp_cast_2 = (_VelocityXYFoamZ.y).xx;
				float2 panner13 = ( 1.0 * _Time.y * temp_cast_2 + ( appendResult34 * _UVScaleB ).xy);
				float3 unpack25 = UnpackNormalScale( tex2D( _NormalB, panner13 ), _NormalScale );
				unpack25.z = lerp( 1, unpack25.z, saturate(_NormalScale) );
				float3 temp_output_17_0 = BlendNormal( unpack21 , unpack25 );
				...
				float eyeDepth3 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float temp_output_5_0 = abs( ( eyeDepth3 - screenPos.w ) );
				float2 temp_cast_4 = (_VelocityXYFoamZ.z).xx;
				float2 panner61 = ( 1.0 * _Time.y * temp_cast_4 + ( temp_output_35_0 * _FoamTiling ).xy);
				float temp_output_63_0 = ( saturate( pow( ( temp_output_5_0 + _FoamDepth ) , _FoamFalloff ) ) * tex2D( _FoamMask, panner61 ).r );
				float lerpResult68 = lerp( _SpecXYSnsZW.z , _SpecXYSnsZW.w , temp_output_63_0);
...
/*ASEBEGIN
Version=18935
2032;-21;1920;1019;977.7695;89.04877;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;36;-539.2219,722.4264;Inherit;False;Property;_UVScale;UVScale;0;0;Create;True;0;0;0;False;0;False;1;0.39;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;82;-568.7695,467.9512;Inherit;False;Property;_UVScaleB;UVScale B;1;0;Create;True;0;0;0;False;0;False;1;0.39;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;62;-531.2057,824.3724;Inherit;False;Property;_VelocityXYFoamZ;Velocity(XY)Foam(Z);8;0;Create;True;0;0;0;False;0;False;0.03,-0.05,0.04;0.03,-0.05,0.04;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;83;-371.7695,510.9512;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;26;-14.10339,615.3041;Inherit;False;Property;_NormalScale;NormalScale;6;0;Create;True;0;0;0;False;0;False;1;0.08;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;55;-118.2469,903.2474;Inherit;False;Property;_FoamDepth;FoamDepth;15;0;Create;True;0;0;0;False;0;False;0.9;0.55;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;70;-459.6713,1019.83;Inherit;False;Property;_FoamTiling;FoamTiling;14;0;Create;True;0;0;0;False;0;False;1;0.37;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.AbsOpNode;5;-277.4228,147.0222;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;7;-103.943,160.8063;Inherit;False;Property;_Depth;Depth;9;0;Create;True;0;0;0;False;0;False;0.9;3.39;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;56;38.63753,897.5466;Inherit;False;Property;_FoamFalloff;FoamFalloff;16;0;Create;True;0;0;0;False;0;False;-3;-4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;9;52.94149,155.1055;Inherit;False;Property;_Falloff;Falloff;10;0;Create;True;0;0;0;False;0;False;-3;-8.38;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;21;151.4966,261.604;Inherit;True;Property;_NormalA;Normal A;4;0;Create;True;0;0;0;False;0;False;-1;None;97e6f79f1ba439c498ca3807fecba7a5;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;25;153.8966,451.3041;Inherit;True;Property;_NormalB;Normal B;5;0;Create;True;0;0;0;False;0;False;-1;None;c5ab9bde27313f24f8dd917f31a18abb;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;42;120.1355,-461.7363;Inherit;False;Property;_Distorsion;Distorsion;11;0;Create;True;0;0;0;False;0;False;0.1;-0.18;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;29;-31.47352,-184.2734;Inherit;False;Property;_ColorB;Color B;3;0;Create;True;0;0;0;False;0;False;0.09838911,0.1034623,0.3113208,0;0.07587209,0.07988282,0.2924527,0.2627451;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;28;-34.22198,-361.5736;Inherit;False;Property;_ColorA;Color A;2;0;Create;True;0;0;0;False;0;False;0.2971698,0.6247243,1,0;0.1320754,0.1320754,0.1320754,0.4039216;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;60;56.99449,998.5726;Inherit;True;Property;_FoamMask;FoamMask;13;0;Create;True;0;0;0;False;0;False;-1;None;3120b2faffa77b640a4c9097ae1ac086;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;65;206.3709,-142.317;Inherit;False;Property;_ColorFoam;ColorFoam;12;0;Create;True;0;0;0;False;0;False;0.9386792,0.9671129,1,0;0.9386792,0.9671128,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;66;290.7857,658.8991;Inherit;False;Property;_SpecXYSnsZW;Spec(XY)Sns(ZW);7;0;Create;True;0;0;0;False;0;False;0.1,0,0.5,0.2;0.07,-0.34,1,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;67;783.6494,568.7939;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
WireConnection;71;7;68;0
WireConnection;71;26;67;0
ASEEND*/
//CHKSM=F58EF2CD7FCFF93DA1D869DFE203875786D328D6