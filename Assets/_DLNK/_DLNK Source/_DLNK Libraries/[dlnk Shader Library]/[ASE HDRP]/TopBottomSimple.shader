...
Shader "DLNK Shaders/ASE HDRP/TopBottomSimple"
{
	Properties
	{
		...
		_BumpScale("BumpScale", Range( 0 , 0.99)) = 0.9
		...
		[ASEEnd]_OcclusionTop("Occlusion Top", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			sampler2D _AlbedoTop;
			sampler2D _BumpMap;
			sampler2D _DetailNormalMap;
			sampler2D _BumpMapTop;
			sampler2D _MetallicGlossMap;
			sampler2D _MetalnessTop;
						...
						)
			{
				...
				float2 uv_DetailMask = packedInput.ase_texcoord5.xy * _DetailMask_ST.xy + _DetailMask_ST.zw;
				...
				float2 texCoord110 = packedInput.ase_texcoord5.xy * temp_cast_0 + float2( 0,0 );
				float2 uv_BumpMap = packedInput.ase_texcoord5.xy * _BumpMap_ST.xy + _BumpMap_ST.zw;
				float3 unpack4 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap ), _BumpScale );
				...
				float3 unpack35 = UnpackNormalScale( tex2D( _DetailNormalMap, uv_DetailNormalMap ), _DetailNormalMapScale );
				unpack35.z = lerp( 1, unpack35.z, saturate(_DetailNormalMapScale) );
				float3 lerpResult46 = lerp( tex2DNode4 , BlendNormal( tex2DNode4 , unpack35 ) , tex2DNode43.a);
				float3 unpack5 = UnpackNormalScale( tex2D( _BumpMapTop, texCoord110 ), _BumpScaleTop );
				unpack5.z = lerp( 1, unpack5.z, saturate(_BumpScaleTop) );
				float3 tex2DNode5 = unpack5;
				float3 lerpResult120 = lerp( tex2DNode5 , BlendNormal( tex2DNode5 , tex2DNode4 ) , _BumpMix);
				float3 normalizedWorldNormal = normalize( normalWS );
				float3 lerpResult11 = lerp( lerpResult46 , lerpResult120 , saturate( (0.0 + (( normalizedWorldNormal.y * _Ammount ) - _Clamp.x) * (1.0 - 0.0) / (_Clamp.y - _Clamp.x)) ));
				...
				float3 tanNormal15 = lerpResult11;
				float3 worldNormal15 = normalize( float3(dot(tanToWorld0,tanNormal15), dot(tanToWorld1,tanNormal15), dot(tanToWorld2,tanNormal15)) );
				float smoothstepResult118 = smoothstep( 0.0 , _Smooth , worldNormal15.y);
				float temp_output_16_0 = saturate( (0.0 + (( smoothstepResult118 * _Ammount ) - _Clamp.x) * (1.0 - 0.0) / (_Clamp.y - _Clamp.x)) );
				float4 lerpResult18 = lerp( lerpResult44 , ( _ColorTop * tex2D( _AlbedoTop, texCoord110 ) ) , temp_output_16_0);
				
				float2 uv_MetallicGlossMap = packedInput.ase_texcoord5.xy * _MetallicGlossMap_ST.xy + _MetallicGlossMap_ST.zw;
				float4 tex2DNode6 = tex2D( _MetallicGlossMap, uv_MetallicGlossMap );
				float4 tex2DNode7 = tex2D( _MetalnessTop, texCoord110 );
				...
				float2 uv_OcclusionMap = packedInput.ase_texcoord5.xy * _OcclusionMap_ST.xy + _OcclusionMap_ST.zw;
				...
				surfaceDescription.BaseColor = lerpResult18.rgb;
				surfaceDescription.Normal = lerpResult11;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = lerpResult14.r;
				...
				surfaceDescription.Smoothness = lerpResult19;
				surfaceDescription.Occlusion = saturate( ( lerpResult51 + ( 1.0 - _OcclusionStrength ) ) );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_DetailMask = packedInput.ase_texcoord.xy * _DetailMask_ST.xy + _DetailMask_ST.zw;
				float4 tex2DNode43 = tex2D( _DetailMask, uv_DetailMask );
				float4 lerpResult44 = lerp( ( _Color * tex2DNode2 ) , ( tex2DNode2 * tex2D( _DetailAlbedoMap, uv_DetailAlbedoMap ) * _Color ) , tex2DNode43.a);
				float2 temp_cast_0 = (_TopTiling).xx;
				float2 texCoord110 = packedInput.ase_texcoord.xy * temp_cast_0 + float2( 0,0 );
				...
				float2 uv_MetallicGlossMap = packedInput.ase_texcoord.xy * _MetallicGlossMap_ST.xy + _MetallicGlossMap_ST.zw;
				float4 tex2DNode6 = tex2D( _MetallicGlossMap, uv_MetallicGlossMap );
				float4 tex2DNode7 = tex2D( _MetalnessTop, texCoord110 );
				float4 lerpResult14 = lerp( ( tex2DNode6 * _Metallic ) , ( tex2DNode7 * _MetallicTop ) , temp_output_16_0);
				...
				float2 uv_OcclusionMap = packedInput.ase_texcoord.xy * _OcclusionMap_ST.xy + _OcclusionMap_ST.zw;
				float4 tex2DNode48 = tex2D( _OcclusionMap, uv_OcclusionMap );
				float lerpResult51 = lerp( tex2DNode48.r , ( tex2DNode48.r + ( 1.0 - _OcclusionTop ) ) , temp_output_16_0);
		...
		Pass
		{
					...
					)
			{
				...
				unpack4.z = lerp( 1, unpack4.z, saturate(_BumpScale) );
				float3 tex2DNode4 = unpack4;
				float2 uv_DetailNormalMap = packedInput.ase_texcoord3.xy * _DetailNormalMap_ST.xy + _DetailNormalMap_ST.zw;
				float3 unpack35 = UnpackNormalScale( tex2D( _DetailNormalMap, uv_DetailNormalMap ), _DetailNormalMapScale );
				unpack35.z = lerp( 1, unpack35.z, saturate(_DetailNormalMapScale) );
				float2 uv_DetailMask = packedInput.ase_texcoord3.xy * _DetailMask_ST.xy + _DetailMask_ST.zw;
				float4 tex2DNode43 = tex2D( _DetailMask, uv_DetailMask );
				float3 lerpResult46 = lerp( tex2DNode4 , BlendNormal( tex2DNode4 , unpack35 ) , tex2DNode43.a);
				float2 temp_cast_0 = (_TopTiling).xx;
				float2 texCoord110 = packedInput.ase_texcoord3.xy * temp_cast_0 + float2( 0,0 );
				float3 unpack5 = UnpackNormalScale( tex2D( _BumpMapTop, texCoord110 ), _BumpScaleTop );
				unpack5.z = lerp( 1, unpack5.z, saturate(_BumpScaleTop) );
				float3 tex2DNode5 = unpack5;
				float3 lerpResult120 = lerp( tex2DNode5 , BlendNormal( tex2DNode5 , tex2DNode4 ) , _BumpMix);
				...
				float2 uv_MetallicGlossMap = packedInput.ase_texcoord3.xy * _MetallicGlossMap_ST.xy + _MetallicGlossMap_ST.zw;
				float4 tex2DNode6 = tex2D( _MetallicGlossMap, uv_MetallicGlossMap );
				float4 tex2DNode7 = tex2D( _MetalnessTop, texCoord110 );
		...
		Pass
		{
						...
						)
			{
				...
				float4 tex2DNode2 = tex2D( _MainTex, uv_MainTex );
				float2 uv_DetailAlbedoMap = packedInput.ase_texcoord7.xy * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
				float2 uv_DetailMask = packedInput.ase_texcoord7.xy * _DetailMask_ST.xy + _DetailMask_ST.zw;
				float4 tex2DNode43 = tex2D( _DetailMask, uv_DetailMask );
				float4 lerpResult44 = lerp( ( _Color * tex2DNode2 ) , ( tex2DNode2 * tex2D( _DetailAlbedoMap, uv_DetailAlbedoMap ) * _Color ) , tex2DNode43.a);
				float2 temp_cast_0 = (_TopTiling).xx;
				float2 texCoord110 = packedInput.ase_texcoord7.xy * temp_cast_0 + float2( 0,0 );
				float2 uv_BumpMap = packedInput.ase_texcoord7.xy * _BumpMap_ST.xy + _BumpMap_ST.zw;
				float3 unpack4 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap ), _BumpScale );
				unpack4.z = lerp( 1, unpack4.z, saturate(_BumpScale) );
				float3 tex2DNode4 = unpack4;
				float2 uv_DetailNormalMap = packedInput.ase_texcoord7.xy * _DetailNormalMap_ST.xy + _DetailNormalMap_ST.zw;
				float3 unpack35 = UnpackNormalScale( tex2D( _DetailNormalMap, uv_DetailNormalMap ), _DetailNormalMapScale );
				unpack35.z = lerp( 1, unpack35.z, saturate(_DetailNormalMapScale) );
				float3 lerpResult46 = lerp( tex2DNode4 , BlendNormal( tex2DNode4 , unpack35 ) , tex2DNode43.a);
				float3 unpack5 = UnpackNormalScale( tex2D( _BumpMapTop, texCoord110 ), _BumpScaleTop );
				...
				float2 uv_MetallicGlossMap = packedInput.ase_texcoord7.xy * _MetallicGlossMap_ST.xy + _MetallicGlossMap_ST.zw;
				float4 tex2DNode6 = tex2D( _MetallicGlossMap, uv_MetallicGlossMap );
				float4 tex2DNode7 = tex2D( _MetalnessTop, texCoord110 );
				float4 lerpResult14 = lerp( ( tex2DNode6 * _Metallic ) , ( tex2DNode7 * _MetallicTop ) , temp_output_16_0);
				...
				float2 uv_OcclusionMap = packedInput.ase_texcoord7.xy * _OcclusionMap_ST.xy + _OcclusionMap_ST.zw;
				float4 tex2DNode48 = tex2D( _OcclusionMap, uv_OcclusionMap );
				float lerpResult51 = lerp( tex2DNode48.r , ( tex2DNode48.r + ( 1.0 - _OcclusionTop ) ) , temp_output_16_0);
...
/*ASEBEGIN
Version=19002
0;0;1920;1019;1600.971;118.0258;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;111;-1494.636,698.1601;Inherit;False;Property;_TopTiling;TopTiling;14;0;Create;True;0;0;0;False;0;False;1;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;16;21.64855,115.5967;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;24;-849.9683,923.2254;Inherit;False;Property;_GlossinessTop;GlossinessTop;23;0;Create;True;0;0;0;False;0;False;0.5;0.33;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-847.3686,842.6254;Inherit;False;Property;_MetallicTop;MetallicTop;24;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;8;-1175.863,90.2252;Inherit;False;Property;_Ammount;Ammount;15;0;Create;True;0;0;0;False;0;False;0.5;0.86;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;23;-851.2681,746.4254;Inherit;False;Property;_Glossiness;Glossiness;6;0;Create;True;0;0;0;False;0;False;0.5;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;7;-666.1178,732.2252;Inherit;True;Property;_MetalnessTop;MetalnessTop;22;0;Create;True;0;0;0;False;0;False;-1;None;45257b258d2fee0469285ed6b9329441;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;34;-1027.37,-566.9212;Inherit;True;Property;_DetailAlbedoMap;DetailAlbedoMap;10;0;Create;True;0;0;0;False;0;False;-1;None;5f2150f9fd0fc6549a37e18e83402ffc;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;30;-658.8688,-745.9743;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;0.8207547,0.8207547,0.8207547,0;1,0.9448276,0.875,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;6;-664.6179,544.8253;Inherit;True;Property;_MetallicGlossMap;MetallicGlossMap;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;31;-662.7689,-372.8746;Inherit;False;Property;_ColorTop;ColorTop;13;0;Create;True;0;0;0;False;0;False;0.8490566,0.8450516,0.8450516,0;0.8490566,0.8450516,0.8450516,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;110;-1302.787,690.5519;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;38;-1486.523,121.6645;Inherit;False;Property;_DetailNormalMapScale;DetailNormalMapScale;12;0;Create;True;0;0;0;False;0;False;1;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;5;-958.6176,430.6252;Inherit;True;Property;_BumpMapTop;BumpMapTop;19;0;Create;True;0;0;0;False;0;False;-1;None;31edad2c5dfcc5d43ac236443b23723b;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;35;-1500.186,207.7091;Inherit;True;Property;_DetailNormalMap;DetailNormalMap;11;0;Create;True;0;0;0;False;0;False;-1;None;a9a9a9870f5dc244cbaef14662a9e5d2;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;2;-729.7998,-565.7997;Inherit;True;Property;_MainTex;Albedo;1;0;Create;False;0;0;0;False;0;False;-1;None;6f7b3c8ee9fdbde45bb71730e4633acd;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;13;-1211.368,451.3252;Inherit;False;Property;_BumpScaleTop;BumpScaleTop;21;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;121;-473.3607,472.8547;Inherit;False;Property;_BumpMix;BumpMix;20;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;117;-1003.142,-260.8409;Inherit;False;Property;_Clamp;Clamp;17;0;Create;True;0;0;0;False;0;False;0,1;0.24,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SamplerNode;4;-958.4177,244.5252;Inherit;True;Property;_BumpMap;BumpMap;2;0;Create;True;0;0;0;False;0;False;-1;None;b0f03efae982d464d9d99bb9fc3db0cc;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;3;-712.8995,-182.3;Inherit;True;Property;_AlbedoTop;AlbedoTop;18;0;Create;True;0;0;0;False;0;False;-1;None;45257b258d2fee0469285ed6b9329441;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;119;-101.9447,-14.76172;Inherit;False;Property;_Smooth;Smooth;16;0;Create;True;0;0;0;False;0;False;0.5;4.99;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;52;-43.20768,1138.505;Inherit;False;Property;_OcclusionTop;Occlusion Top;25;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-1227.168,216.4252;Inherit;False;Property;_BumpScale;BumpScale;3;0;Create;True;0;0;0;False;0;False;0.9;1;0;0.99;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;48;-161.4265,896.813;Inherit;True;Property;_OcclusionMap;Occlusion Map;7;0;Create;True;0;0;0;False;0;False;-1;None;35d14d51d551b114ba76c8a31b3035cd;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;131;0;18;0
WireConnection;131;1;11;0
WireConnection;131;4;14;0
WireConnection;131;7;19;0
WireConnection;131;8;54;0
ASEEND*/
//CHKSM=CA469AD02612D24063CF6270DA561FDC66FE28CC